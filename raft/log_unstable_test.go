...
func TestUnstableMaybeFirstIndex(t *testing.T) {
	...
	tests := []struct {
		...
		wok	bool
		windex	uint64
	}{{[]pb.Entry{{Index: 5, Term: 1}}, 5, nil, false, 0}, {[]pb.Entry{}, 0, nil, false, 0}, {[]pb.Entry{{Index: 5, Term: 1}}, 5, &pb.Snapshot{Metadata: pb.SnapshotMetadata{Index: 4, Term: 1}}, true, 5}, {[]pb.Entry{}, 5, &pb.Snapshot{Metadata: pb.SnapshotMetadata{Index: 4, Term: 1}}, true, 5}}
	for i, tt := range tests {
		u := unstable{entries: tt.entries, offset: tt.offset, snapshot: tt.snap, logger: raftLogger}
...
func TestMaybeLastIndex(t *testing.T) {
	...
	tests := []struct {
		...
		wok	bool
		windex	uint64
	}{{[]pb.Entry{{Index: 5, Term: 1}}, 5, nil, true, 5}, {[]pb.Entry{{Index: 5, Term: 1}}, 5, &pb.Snapshot{Metadata: pb.SnapshotMetadata{Index: 4, Term: 1}}, true, 5}, {[]pb.Entry{}, 5, &pb.Snapshot{Metadata: pb.SnapshotMetadata{Index: 4, Term: 1}}, true, 4}, {[]pb.Entry{}, 0, nil, false, 0}}
	for i, tt := range tests {
		u := unstable{entries: tt.entries, offset: tt.offset, snapshot: tt.snap, logger: raftLogger}
...
func TestUnstableStableTo(t *testing.T) {
	...
	tests := []struct {
		...
		woffset		uint64
		wlen		int
	}{{[]pb.Entry{}, 0, nil, 5, 1, 0, 0}, {[]pb.Entry{{Index: 5, Term: 1}}, 5, nil, 5, 1, 6, 0}, {[]pb.Entry{{Index: 5, Term: 1}, {Index: 6, Term: 1}}, 5, nil, 5, 1, 6, 1}, {[]pb.Entry{{Index: 6, Term: 2}}, 6, nil, 6, 1, 6, 1}, {[]pb.Entry{{Index: 5, Term: 1}}, 5, nil, 4, 1, 5, 1}, {[]pb.Entry{{Index: 5, Term: 1}}, 5, nil, 4, 2, 5, 1}, {[]pb.Entry{{Index: 5, Term: 1}}, 5, &pb.Snapshot{Metadata: pb.SnapshotMetadata{Index: 4, Term: 1}}, 5, 1, 6, 0}, {[]pb.Entry{{Index: 5, Term: 1}, {Index: 6, Term: 1}}, 5, &pb.Snapshot{Metadata: pb.SnapshotMetadata{Index: 4, Term: 1}}, 5, 1, 6, 1}, {[]pb.Entry{{Index: 6, Term: 2}}, 6, &pb.Snapshot{Metadata: pb.SnapshotMetadata{Index: 5, Term: 1}}, 6, 1, 6, 1}, {[]pb.Entry{{Index: 5, Term: 1}}, 5, &pb.Snapshot{Metadata: pb.SnapshotMetadata{Index: 4, Term: 1}}, 4, 1, 5, 1}, {[]pb.Entry{{Index: 5, Term: 2}}, 5, &pb.Snapshot{Metadata: pb.SnapshotMetadata{Index: 4, Term: 2}}, 4, 1, 5, 1}}
	for i, tt := range tests {
		u := unstable{entries: tt.entries, offset: tt.offset, snapshot: tt.snap, logger: raftLogger}
