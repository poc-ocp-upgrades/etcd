...
func TestIntervalTreeVisitExit(t *testing.T) {
	...
	tests := []struct {
		...
		return false
	}, wcount: 1}, {f: func(n *IntervalValue) bool {
		return n.Ivl.Begin.Compare(ivls[0].Begin) <= 0
	}, wcount: 2}, {f: func(n *IntervalValue) bool {
		return n.Ivl.Begin.Compare(ivls[2].Begin) < 0
	}, wcount: 3}, {f: func(n *IntervalValue) bool {
		return true
	}, wcount: 4}}
	for i, tt := range tests {
		ivt := &IntervalTree{}
