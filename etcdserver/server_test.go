...
func TestDoLocalAction(t *testing.T) {
	...
	}{{pb.Request{Method: "GET", ID: 1, Wait: true}, Response{Watcher: store.NewNopWatcher()}, nil, []testutil.Action{{Name: "Watch"}}}, {pb.Request{Method: "GET", ID: 1}, Response{Event: &store.Event{}}, nil, []testutil.Action{{Name: "Get", Params: []interface{}{"", false, false}}}}, {pb.Request{Method: "HEAD", ID: 1}, Response{Event: &store.Event{}}, nil, []testutil.Action{{Name: "Get", Params: []interface{}{"", false, false}}}}, {pb.Request{Method: "BADMETHOD", ID: 1}, Response{}, ErrUnknownMethod, []testutil.Action{}}}
	for i, tt := range tests {
		st := mockstore.NewRecorder()
		srv := &EtcdServer{store: st, reqIDGen: idutil.NewGenerator(0, time.Time{})}
...
func TestDoBadLocalAction(t *testing.T) {
	...
	tests := []struct {
		req		pb.Request
		wactions	[]testutil.Action
	}{{pb.Request{Method: "GET", ID: 1, Wait: true}, []testutil.Action{{Name: "Watch"}}}, {pb.Request{Method: "GET", ID: 1}, []testutil.Action{{Name: "Get", Params: []interface{}{"", false, false}}}}, {pb.Request{Method: "HEAD", ID: 1}, []testutil.Action{{Name: "Get", Params: []interface{}{"", false, false}}}}}
	for i, tt := range tests {
...
func TestApplyRepeat(t *testing.T) {
	...
	r := newRaftNode(raftNodeConfig{Node: n, raftStorage: raft.NewMemoryStorage(), storage: mockstorage.NewStorageRecorder(""), transport: rafthttp.NewNopTransporter()})
	s := &EtcdServer{r: *r, store: st, cluster: cl, reqIDGen: idutil.NewGenerator(0, time.Time{}), SyncTicker: &time.Ticker{}}
	...
	ents = []raftpb.Entry{{Index: 2, Type: raftpb.EntryConfChange, Data: pbutil.MustMarshal(cc)}}
	n.readyc <- raft.Ready{CommittedEntries: ents}
	act, err := n.Wait(1)
...
func TestApplyRequest(t *testing.T) {
	...
	tests := []struct {
		...
		wresp		Response
		wactions	[]testutil.Action
	}{{pb.Request{Method: "POST", ID: 1}, Response{Event: &store.Event{}}, []testutil.Action{{Name: "Create", Params: []interface{}{"", false, "", true, store.TTLOptionSet{ExpireTime: time.Time{}}}}}}, {pb.Request{Method: "POST", ID: 1, Expiration: 1337}, Response{Event: &store.Event{}}, []testutil.Action{{Name: "Create", Params: []interface{}{"", false, "", true, store.TTLOptionSet{ExpireTime: time.Unix(0, 1337)}}}}}, {pb.Request{Method: "POST", ID: 1, Dir: true}, Response{Event: &store.Event{}}, []testutil.Action{{Name: "Create", Params: []interface{}{"", true, "", true, store.TTLOptionSet{ExpireTime: time.Time{}}}}}}, {pb.Request{Method: "PUT", ID: 1}, Response{Event: &store.Event{}}, []testutil.Action{{Name: "Set", Params: []interface{}{"", false, "", store.TTLOptionSet{ExpireTime: time.Time{}}}}}}, {pb.Request{Method: "PUT", ID: 1, Dir: true}, Response{Event: &store.Event{}}, []testutil.Action{{Name: "Set", Params: []interface{}{"", true, "", store.TTLOptionSet{ExpireTime: time.Time{}}}}}}, {pb.Request{Method: "PUT", ID: 1, PrevExist: pbutil.Boolp(true)}, Response{Event: &store.Event{}}, []testutil.Action{{Name: "Update", Params: []interface{}{"", "", store.TTLOptionSet{ExpireTime: time.Time{}}}}}}, {pb.Request{Method: "PUT", ID: 1, PrevExist: pbutil.Boolp(false)}, Response{Event: &store.Event{}}, []testutil.Action{{Name: "Create", Params: []interface{}{"", false, "", false, store.TTLOptionSet{ExpireTime: time.Time{}}}}}}, {pb.Request{Method: "PUT", ID: 1, PrevExist: pbutil.Boolp(true), PrevIndex: 1}, Response{Event: &store.Event{}}, []testutil.Action{{Name: "CompareAndSwap", Params: []interface{}{"", "", uint64(1), "", store.TTLOptionSet{ExpireTime: time.Time{}}}}}}, {pb.Request{Method: "PUT", ID: 1, PrevExist: pbutil.Boolp(false), PrevIndex: 1}, Response{Event: &store.Event{}}, []testutil.Action{{Name: "Create", Params: []interface{}{"", false, "", false, store.TTLOptionSet{ExpireTime: time.Time{}}}}}}, {pb.Request{Method: "PUT", ID: 1, PrevIndex: 1}, Response{Event: &store.Event{}}, []testutil.Action{{Name: "CompareAndSwap", Params: []interface{}{"", "", uint64(1), "", store.TTLOptionSet{ExpireTime: time.Time{}}}}}}, {pb.Request{Method: "PUT", ID: 1, PrevValue: "bar"}, Response{Event: &store.Event{}}, []testutil.Action{{Name: "CompareAndSwap", Params: []interface{}{"", "bar", uint64(0), "", store.TTLOptionSet{ExpireTime: time.Time{}}}}}}, {pb.Request{Method: "PUT", ID: 1, PrevIndex: 1, PrevValue: "bar"}, Response{Event: &store.Event{}}, []testutil.Action{{Name: "CompareAndSwap", Params: []interface{}{"", "bar", uint64(1), "", store.TTLOptionSet{ExpireTime: time.Time{}}}}}}, {pb.Request{Method: "DELETE", ID: 1}, Response{Event: &store.Event{}}, []testutil.Action{{Name: "Delete", Params: []interface{}{"", false, false}}}}, {pb.Request{Method: "DELETE", ID: 1, PrevIndex: 1}, Response{Event: &store.Event{}}, []testutil.Action{{Name: "CompareAndDelete", Params: []interface{}{"", "", uint64(1)}}}}, {pb.Request{Method: "DELETE", ID: 1, PrevValue: "bar"}, Response{Event: &store.Event{}}, []testutil.Action{{Name: "CompareAndDelete", Params: []interface{}{"", "bar", uint64(0)}}}}, {pb.Request{Method: "DELETE", ID: 1, PrevIndex: 5, PrevValue: "bar"}, Response{Event: &store.Event{}}, []testutil.Action{{Name: "CompareAndDelete", Params: []interface{}{"", "bar", uint64(5)}}}}, {pb.Request{Method: "QGET", ID: 1}, Response{Event: &store.Event{}}, []testutil.Action{{Name: "Get", Params: []interface{}{"", false, false}}}}, {pb.Request{Method: "SYNC", ID: 1}, Response{}, []testutil.Action{{Name: "DeleteExpiredKeys", Params: []interface{}{time.Unix(0, 0)}}}}, {pb.Request{Method: "SYNC", ID: 1, Time: 12345}, Response{}, []testutil.Action{{Name: "DeleteExpiredKeys", Params: []interface{}{time.Unix(0, 12345)}}}}, {pb.Request{Method: "BADMETHOD", ID: 1}, Response{Err: ErrUnknownMethod}, []testutil.Action{}}}
	for i, tt := range tests {
		st := mockstore.NewRecorder()
...
func TestApplyRequestOnAdminMemberAttributes(t *testing.T) {
	...
	srv.applyV2 = &applierV2store{store: srv.store, cluster: srv.cluster}
	req := pb.Request{Method: "PUT", ID: 1, Path: membership.MemberAttributesStorePath(1), Val: `{"Name":"abc","ClientURLs":["http://127.0.0.1:2379"]}`}
...
func TestApplyConfChangeShouldStop(t *testing.T) {
	...
	srv := &EtcdServer{id: 1, r: *r, cluster: cl}
	cc := raftpb.ConfChange{Type: raftpb.ConfChangeRemoveNode, NodeID: 2}
...
func TestApplyConfigChangeUpdatesConsistIndex(t *testing.T) {
	...
	r := newRaftNode(raftNodeConfig{Node: newNodeNop(), transport: rafthttp.NewNopTransporter()})
	srv := &EtcdServer{id: 1, r: *r, cluster: cl, w: wait.New()}
	now := time.Now()
...
func TestApplyMultiConfChangeShouldStop(t *testing.T) {
	...
	r := newRaftNode(raftNodeConfig{Node: newNodeNop(), transport: rafthttp.NewNopTransporter()})
	srv := &EtcdServer{id: 2, r: *r, cluster: cl, w: wait.New()}
	ents := []raftpb.Entry{}
	for i := 1; i <= 4; i++ {
		ent := raftpb.Entry{Term: 1, Index: uint64(i), Type: raftpb.EntryConfChange, Data: pbutil.MustMarshal(&raftpb.ConfChange{Type: raftpb.ConfChangeRemoveNode, NodeID: uint64(i)})}
...
func TestDoProposal(t *testing.T) {
	...
	for i, tt := range tests {
		st := mockstore.NewRecorder()
		r := newRaftNode(raftNodeConfig{Node: newNodeCommitter(), storage: mockstorage.NewStorageRecorder(""), raftStorage: raft.NewMemoryStorage(), transport: rafthttp.NewNopTransporter()})
		srv := &EtcdServer{Cfg: ServerConfig{TickMs: 1}, r: *r, store: st, reqIDGen: idutil.NewGenerator(0, time.Time{}), SyncTicker: &time.Ticker{}}
		srv.applyV2 = &applierV2store{store: srv.store, cluster: srv.cluster}
		srv.start()
...
func TestSyncTrigger(t *testing.T) {
	...
	tk := &time.Ticker{C: st}
	r := newRaftNode(raftNodeConfig{Node: n, raftStorage: raft.NewMemoryStorage(), transport: rafthttp.NewNopTransporter(), storage: mockstorage.NewStorageRecorder("")})
	srv := &EtcdServer{Cfg: ServerConfig{TickMs: 1}, r: *r, store: mockstore.NewNop(), SyncTicker: tk, reqIDGen: idutil.NewGenerator(0, time.Time{})}
	go func() {
		srv.start()
		n.readyc <- raft.Ready{SoftState: &raft.SoftState{RaftState: raft.StateLeader}}
		st <- time.Time{}
...
func TestSnapshot(t *testing.T) {
	...
	r := newRaftNode(raftNodeConfig{Node: newNodeNop(), raftStorage: s, storage: p})
	srv := &EtcdServer{r: *r, store: st}
...
func TestSnapshotOrdering(t *testing.T) {
	...
	r := newRaftNode(raftNodeConfig{isIDRemoved: func(id uint64) bool {
		return cl.IsIDRemoved(types.ID(id))
	}, Node: n, transport: tr, storage: p, raftStorage: rs})
	s := &EtcdServer{Cfg: ServerConfig{DataDir: testdir}, r: *r, store: st, snapshotter: snap.New(snapdir), cluster: cl, SyncTicker: &time.Ticker{}}
	s.applyV2 = &applierV2store{store: s.store, cluster: s.cluster}
	be, tmpPath := backend.NewDefaultTmpBackend()
...
func TestTriggerSnap(t *testing.T) {
	...
	st := mockstore.NewRecorder()
	p := mockstorage.NewStorageRecorderStream("")
	r := newRaftNode(raftNodeConfig{Node: newNodeCommitter(), raftStorage: raft.NewMemoryStorage(), storage: p, transport: rafthttp.NewNopTransporter()})
	srv := &EtcdServer{Cfg: ServerConfig{TickMs: 1, SnapCount: uint64(snapc)}, r: *r, store: st, reqIDGen: idutil.NewGenerator(0, time.Time{}), SyncTicker: &time.Ticker{}}
	srv.applyV2 = &applierV2store{store: srv.store, cluster: srv.cluster}
	srv.kv = mvcc.New(be, &lease.FakeLessor{}, &srv.consistIndex)
	srv.be = be
	srv.start()
...
func TestConcurrentApplyAndSnapshotV3(t *testing.T) {
	...
	r := newRaftNode(raftNodeConfig{isIDRemoved: func(id uint64) bool {
		return cl.IsIDRemoved(types.ID(id))
	}, Node: n, transport: tr, storage: mockstorage.NewStorageRecorder(testdir), raftStorage: rs})
	s := &EtcdServer{Cfg: ServerConfig{DataDir: testdir}, r: *r, store: st, snapshotter: snap.New(testdir), cluster: cl, SyncTicker: &time.Ticker{}}
	s.applyV2 = &applierV2store{store: s.store, cluster: s.cluster}
	be, tmpPath := backend.NewDefaultTmpBackend()
	defer func() {
		os.RemoveAll(tmpPath)
...
func TestPublishRetry(t *testing.T) {
	...
	srv := &EtcdServer{Cfg: ServerConfig{TickMs: 1}, r: *newRaftNode(raftNodeConfig{Node: n}), w: mockwait.NewNop(), stopping: make(chan struct{}), reqIDGen: idutil.NewGenerator(0, time.Time{}), SyncTicker: &time.Ticker{}, ctx: ctx, cancel: cancel}
	ch := make(chan struct{})
	go func() {
		defer close(ch)
...
func TestUpdateVersion(t *testing.T) {
	...
	w := wait.NewWithResponse(ch)
	ctx, cancel := context.WithCancel(context.TODO())
	srv := &EtcdServer{id: 1, Cfg: ServerConfig{TickMs: 1}, r: *newRaftNode(raftNodeConfig{Node: n}), attributes: membership.Attributes{Name: "node1", ClientURLs: []string{"http://node1.com"}}, cluster: &membership.RaftCluster{}, w: w, reqIDGen: idutil.NewGenerator(0, time.Time{}), SyncTicker: &time.Ticker{}, ctx: ctx, cancel: cancel}
...
type nodeProposalBlockerRecorder struct{ nodeRecorder }
