...
var (
	activePeers		= prometheus.NewGaugeVec(prometheus.GaugeOpts{Namespace: "etcd", Subsystem: "network", Name: "active_peers", Help: "The current number of active peer connections."}, []string{"Local", "Remote"})
	disconnectedPeers	= prometheus.NewCounterVec(prometheus.CounterOpts{Namespace: "etcd", Subsystem: "network", Name: "disconnected_peers_total", Help: "The total number of disconnected peers."}, []string{"Local", "Remote"})
	...
	rttSec			= prometheus.NewHistogramVec(prometheus.HistogramOpts{Namespace: "etcd", Subsystem: "network", Name: "peer_round_trip_time_seconds", Help: "Round-Trip-Time histogram between peers", Buckets: prometheus.ExponentialBuckets(0.0001, 2, 16)}, []string{"To"})
)
