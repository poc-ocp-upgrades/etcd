...
func NewQuotaKVServer(s *etcdserver.EtcdServer) pb.KVServer {
	_logClusterCodePath()
	defer _logClusterCodePath()
	return &quotaKVServer{NewKVServer(s), quotaAlarmer{etcdserver.NewBackendQuota(s, "kv"), s, s.ID()}}
}
...
func NewQuotaLeaseServer(s *etcdserver.EtcdServer) pb.LeaseServer {
	_logClusterCodePath()
	defer _logClusterCodePath()
	return &quotaLeaseServer{NewLeaseServer(s), quotaAlarmer{etcdserver.NewBackendQuota(s, "lease"), s, s.ID()}}
}
