...
func (srv *Server) creatEtcdCmd(fromSnapshot bool) {
	...
	srv.lg.Info("creating etcd command", zap.String("etcd-exec-path", etcdPath), zap.Strings("etcd-flags", etcdFlags), zap.String("failpoint-http-addr", srv.Member.FailpointHTTPAddr), zap.String("failpoint-addr", u.Host))
...
func (srv *Server) handle_SIGQUIT_ETCD_AND_ARCHIVE_DATA() (*rpcpb.Response, error) {
	...
	srv.etcdLogFile.Sync()
	srv.etcdLogFile.Close()
	if err = archive(srv.Member.BaseDir, srv.Member.EtcdLogPath, srv.Member.Etcd.DataDir); err != nil {
		return nil, err
	}
...
func (srv *Server) handle_UNBLACKHOLE_PEER_PORT_TX_RX() (*rpcpb.Response, error) {
	...
	return &rpcpb.Response{Success: true, Status: "unblackholed peer port tx/rx"}, nil
}
...
func (srv *Server) handle_UNDELAY_PEER_PORT_TX_RX() (*rpcpb.Response, error) {
	...
	return &rpcpb.Response{Success: true, Status: "undelayed peer port tx/rx"}, nil
}
