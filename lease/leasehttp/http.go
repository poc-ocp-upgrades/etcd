...
func (h *leaseHandler) ServeHTTP(w http.ResponseWriter, r *http.Request) {
	...
	case LeaseInternalPrefix:
		...
		resp := &leasepb.LeaseInternalResponse{LeaseTimeToLiveResponse: &pb.LeaseTimeToLiveResponse{Header: &pb.ResponseHeader{}, ID: lreq.LeaseTimeToLiveRequest.ID, TTL: int64(l.Remaining().Seconds()), GrantedTTL: l.TTL()}}
