...
func TestNew(t *testing.T) {
	...
	r := &walpb.Record{Type: snapshotType, Data: pbutil.MustMarshal(&walpb.Snapshot{})}
...
func TestCut(t *testing.T) {
	...
	defer f.Close()
	nw := &WAL{decoder: newDecoder(f), start: snap}
...
func TestScanWalName(t *testing.T) {
	...
	tests := []struct {
		...
		wseq, windex	uint64
		wok		bool
	}{{"0000000000000000-0000000000000000.wal", 0, 0, true}, {"0000000000000000.wal", 0, 0, false}, {"0000000000000000-0000000000000000.snap", 0, 0, false}}
	for i, tt := range tests {
